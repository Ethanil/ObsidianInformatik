Eine first-order signature $\Sigma = <F_{\Sigma},P_{\Sigma}>$ besteht aus non-empty, disjoint und countable sets $F_{\Sigma}$ und $P_{\Sigma}$, also Functions und Predicate Symbols.

...
- Für jedes $x_{0} \in M$ konvergeirt die Folge $(x_n)$ mit $x_{n+1}=f(x_{n}), n \in \mathbb{N}$ gegen $v$ und es gelten die folgenden Fehlerabschätzungen für jedes $n \in \mathbb{N}^*:$
$$\begin{align}
